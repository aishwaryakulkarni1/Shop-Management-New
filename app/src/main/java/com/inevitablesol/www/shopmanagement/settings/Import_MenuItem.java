...
public class Import_MenuItem extends AppCompatActivity
{
    ...
    private static final String TAG = "Import_MenuItem";
    private AppCompatButton downloadFile;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_import__menu_item);
        ...
        downloadFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/uc?export=download&id=1UNJlm0PKYKHQvNs9buOfC_AutqYn_zsi")));
    ...
    private void uploadFile()
    {
        ...
        if(isStoragePermissionGranted())
        {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT)
            {
                ...
                {
                    Ion.with(this)
                            .load("POST", "http://35.161.99.113:9000/webapi/product/menuitemimportdata")
                            ...
                            .setCallback(new FutureCallback<JsonObject>() {
                                ...
                                public void onCompleted(Exception e, JsonObject result) {
                                    ...
                                    Toast.makeText(getApplicationContext(), "Menu Item uploaded successfully", Toast.LENGTH_LONG).show();
                                    finish();
                                }
                            });
    ...
    {
        int result = ContextCompat.checkSelfPermission(Import_MenuItem.this, Manifest.permission.READ_EXTERNAL_STORAGE);
