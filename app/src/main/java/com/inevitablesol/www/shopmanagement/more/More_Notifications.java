...
public class More_Notifications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_more__notifications);
    ...
    private void sendMail(String email)
    {
        ...
        {
            Toast.makeText(More_Notifications.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void callPhone()
    {
        ...
        if (ActivityCompat.checkSelfPermission(More_Notifications.this,
