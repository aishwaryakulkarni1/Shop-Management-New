    ...
    public void parseJSON()
    {
        ...
        try
        {
           ...
           company = new String[titles_list.length()];
            ...
            item_barcode=new String[titles_list.length()];
            mUnit=new String[titles_list.length()];
            unit=new String[titles_list.length()];
               ...
               stockInfo.setCompany(company[i]);
                ...
                stockInfo.setGst(gst[i]);
                 ...
                 stockInfo.setO_mrp(o_mrp[i]);
                  ...
                  stockInfo.setMunit(mUnit[i]);
                  stockInfo.setUnit(unit[i]);
                  stockInfo.setItembarcode(item_barcode[i]);
