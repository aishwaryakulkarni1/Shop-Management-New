...
public class DuePayment_Paytm extends AppCompatActivity
{
    ...
    private Context context=DuePayment_Paytm.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_due_payment__paytm);
    ...
    private void updateInvoiceData()
    {
        ...
        Volley.newRequestQueue(DuePayment_Paytm.this).add(new StringRequest(Request.Method.POST, WebApi.INVIOCEAMOUNTPAIDHISTORY, new Response.Listener<String>() {
            @Override
                    ...
                    } else
                    {
                        try
                        {
                            ...
                            if (message.equalsIgnoreCase("Updated succesfully"))
                            {
                                ...
                                loading.dismiss();
                                String transactionId=tran_numbner.getText().toString().trim();

                                Intent intent = new Intent(DuePayment_Paytm.this, Billing_paidAmountSuccess.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof NoConnectionError) {
                    Toast.makeText(DuePayment_Paytm.this, "Please connect to the internet before continuing", Toast.LENGTH_SHORT).show();
