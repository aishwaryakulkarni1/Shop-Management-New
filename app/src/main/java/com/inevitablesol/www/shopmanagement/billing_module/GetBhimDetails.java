...
public class GetBhimDetails extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_get_bhim_details);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.new_bankdetails:
                Intent intent = new Intent(GetBhimDetails.this, Billing_Settings.class);
    ...
    private void getUserInfo()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, WebApi.SHOP_DOCUMENTS, new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                ...
                try
                {
                    ...
                    Log.d(TAG, "onResponse: Link"+jsonObject1.getString("ImageLink"));
                          Picasso.with(GetBhimDetails.this).load(jsonObject1.getString("ImageLink")).fit().centerInside().into(imageView);
            ...
            public void onErrorResponse(VolleyError error)
            {
                loading.dismiss();
                if (error instanceof NoConnectionError) {
                    Toast.makeText(GetBhimDetails.this, "Please connect to the internet before continuing", Toast.LENGTH_SHORT).show();
