...
public class BillingCartItems extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = "BillingCartItems";
    private GlobalPool globalPool;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.selected_item_in_cart);
        ...
        recyclerView.setLayoutManager(layoutManager);
         billingStockAdater = new CalculateBillItemAdapter(getApplicationContext(), itemDetalisClasses, BillingCartItems.this);
    ...
    private void showDialog_discount(final ItemDetalisClass billData)
    {
            ...
            public void onClick(View v)
            {
                try
                {
                    ...
                    if(globalPool.getGst_status())
                    {
                        ...
                        {
                            Toast.makeText(BillingCartItems.this, "Please add Discount", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else
                    {
                ...
                {
                    Toast.makeText(BillingCartItems.this, "Please refresh Page", Toast.LENGTH_SHORT).show();
                }
        ...
        et_instantDiscount.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s)
            {
                ...
                try
                {
                    Log.d(TAG, "afterTextChanged: "+billData.getUnit());
                    Log.d(TAG, "afterTextChanged: Qty"+billData.getSelectd_qty());
                    Log.d(TAG, "afterTextChanged: MUnit"+billData.getmUnit());
...
//
//        final  Dialog dialog=new Dialog(this);
//        dialog.setContentView(R.layout.add_instant_discount);
//        dialog.setCancelable(false);
//
//
//        TextView  tx_itemName=(TextView)dialog.findViewById(R.id.dis_itemName);
...
//
//        TextView  tx_unitPrice=(TextView)dialog.findViewById(R.id.dis_unitPrice);
//        tx_unitPrice.setText(billData.getUnit_price());
//        TextView tx_totalPrice=(TextView)dialog.findViewById(R.id.dis_totalAmount);
//        tx_totalPrice.setText(billData.getTotalPrice());
//        final TextInputEditText edt_discount=(TextInputEditText)dialog.findViewById(R.id.instant_discount);
//        final TextView tx_discountedAmount=(TextView)dialog.findViewById(R.id.dis_discountedPrice);
//
//        AppCompatButton add_Discount=(AppCompatButton)dialog.findViewById(R.id.add_discount);
//
//        add_Discount.setOnClickListener(new View.OnClickListener() {
...
//                try
//                {
//                    String taxable_value=tx_discountedAmount.getText().toString().trim();
//                    String qty=billData.getSelectd_qty();
//                    String gst=billData.getGst_per();
//                    Log.d(TAG, "onClick: GST And Qty"+gst+"Qty :"+qty);
//                    double taxvalue=Double.parseDouble(qty)*Double.parseDouble(taxable_value);
//                    double taxab_value=Math.round(taxvalue*100.0)/100.00f;
//
//                    double gst_per=  Double.parseDouble(gst)/100.00f;
//                    double cal_gst=  taxab_value*gst_per;
...
//                    if(!taxable_value.isEmpty())
//                    {
//                        Log.d(TAG, "onClick: Taxable Value"+taxable_value);
//                        billData.setTotal_taxableValue(String.valueOf(taxab_value));
//
//                        sqlDataBase.updatedDiscontedPrice(String.valueOf(taxab_value), billData.getItem_id(),String.valueOf(totalAmount),String.valueOf(cal_gst));
//                         billingStockAdater.notifyDataSetChanged();
...
//                    double discounted_price=Double.parseDouble(billData.getUnit_price())-discount;
//                    tx_discountedAmount.setText(String.valueOf(discounted_price));
//                } catch (NumberFormatException e1)
//                {
//                    double discounted_price=Double.parseDouble(billData.getTotalPrice())-0;
//                    tx_discountedAmount.setText(String.valueOf(discounted_price));
//                    e1.printStackTrace();
//                }
//
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId()) {
            case R.id.billing_nextToCalculate:
                Intent intent=new Intent(BillingCartItems.this,CalculateBillingCart.class);
