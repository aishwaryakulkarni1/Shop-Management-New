...
public class HighestSellingDay extends AppCompatActivity implements WEBAPI
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.highest_selling_day);
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        try
                        {
                            ...
                            if(message.equalsIgnoreCase("true"))
                            {
                                ...
                                Top_class_Adapter top_class_adapter=new Top_class_Adapter(top_seven_classes,HighestSellingDay.this);
