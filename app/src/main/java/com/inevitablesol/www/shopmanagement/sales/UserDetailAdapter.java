...
public class UserDetailAdapter extends ArrayAdapter<String>
{
    private final Activity context;
    private final String[] pid;
    private final String [] p_name;

    public UserDetailAdapter(Activity context, int resource,String[] name,String[] id) {
    ...
    public UserDetailAdapter(Context context, int product_list, String[] vName, String[] vId)
    {
